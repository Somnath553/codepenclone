...
function Icon({displayName}) {
  return (
    <div>
      {displayName==="Html" && <svg viewBox="0 0 15 15" class="file-type-icon" id="icon-file-html">
...
{displayName==="Css" &&<svg viewBox="0 0 15 15" class="file-type-icon" id="icon-file-css">
...
{displayName==="Js" &&<svg viewBox="0 0 15 15" class="file-type-icon" id="icon-file-js">
